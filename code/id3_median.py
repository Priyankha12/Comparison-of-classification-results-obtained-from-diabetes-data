...
"""
dot_file = tree.export_graphviz(decision_tree_classifier, out_file='id3_median.dot', feature_names = list(data)[0:-1],class_names = ['healthy', 'ill'])
dot_file_pruned = tree.export_graphviz(decision_tree_classifier, out_file='id3_median_pruned.dot', feature_names = list(data)[0:-1],class_names = ['healthy', 'ill'],max_depth=3)

subprocess.call(['dot', '-Tpng', 'id3_median.dot', '-o' 'id3_median.png'])
subprocess.call(['dot', '-Tpng', 'id3_median_pruned.dot', '-o' 'id3_median_pruned.png'])
"""
