...
"""
#Visualization
dot_file = tree.export_graphviz(decision_tree_classifier, out_file='cart_mean.dot', feature_names = list(data)[0:-1],class_names = ['healthy', 'ill'])
dot_file_pruned = tree.export_graphviz(decision_tree_classifier, out_file='cart_mean_pruned.dot', feature_names = list(data)[0:-1],class_names = ['healthy', 'ill'],max_depth=3)

subprocess.call(['dot', '-Tpng', 'cart_mean.dot', '-o' 'cart_mean.png'])
subprocess.call(['dot', '-Tpng', 'cart_mean_pruned.dot', '-o' 'cat_mean_pruned.png'])
