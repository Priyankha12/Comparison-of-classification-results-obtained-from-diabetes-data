...
"""
dot_file = tree.export_graphviz(decision_tree_classifier, out_file='cart_drop.dot', feature_names = list(data)[0:-1],class_names = ['healthy', 'ill'])
dot_file_pruned = tree.export_graphviz(decision_tree_classifier, out_file='cart_drop_pruned.dot', feature_names = list(data)[0:-1],class_names = ['healthy', 'ill'],max_depth=3)

subprocess.call(['dot', '-Tpng', 'cart_drop.dot', '-o' 'cart_drop.png'])
subprocess.call(['dot', '-Tpng', 'cart_drop_pruned.dot', '-o' 'cart_drop_pruned.png'])
