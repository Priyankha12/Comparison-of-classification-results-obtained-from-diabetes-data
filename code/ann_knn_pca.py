...
#Reading the data
data = pd.read_csv('dataset/diabetes_knn_pca.csv')
...
model.add(Dense(8, input_dim=8, init='uniform', activation='tanh'))
...
#Training the model
model.fit(X_train, y_train,nb_epoch=10,validation_data=(X_test, y_test),batch_size=16,callbacks=callbacks_list,verbose=0)
